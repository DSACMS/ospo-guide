# CMS DSAC OSPO REPORT: CVE-2024-3094: Backdoor in xz
...
This incident highlights both the strengths and weaknesses of open source at present. As per a recent blog post from CISA: “We are fortunate that the open nature of the wider open source ecosystem allowed a developer to spot this supply chain compromise before it could cause much harm.”
...
A problem that arises when studying open source software supply chains is something known as the “Nebraska problem:” When a software project that is critical to most of the world’s software use-cases is poorly funded, poorly maintained, or poorly staffed, etc.
...
Luckily, we are not alone in our efforts to foster a culture of open source security. There are reputable groups in this area such as the Open Source Security Foundation (OpenSSF) which help open software projects integrate healthy open source security practices into their development process.
