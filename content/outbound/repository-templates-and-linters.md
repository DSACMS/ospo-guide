...
Below are templates and linters that can used to start new projects or add to existing projects.
...
Alternatively, [repo-scaffolder](https://dsacms.github.io/repo-scaffolder) is a tool that can assist with adding this content to repositories:

- [Get started on your repository using repo-scaffolder](https://dsacms.github.io/repo-scaffolder#repository-templates)
- [Create a new repository by running cookiecutter](https://github.com/DSACMS/repo-scaffolder?tab=readme-ov-file#know-what-maturity-tier-you-need)
- [Add required files to an existing repository using cookiecutter](https://github.com/DSACMS/repo-scaffolder?tab=readme-ov-file#update-an-existing-repository-using-repo-scaffolder)
- [Add required files to an existing repository using repolinter](https://github.com/DSACMS/repo-scaffolder#add-files-to-an-existing-repository-using-repolinter)
...
- repo-scaffolder
  - [Landing Page](https://dsacms.github.io/repo-scaffolder)
  - [Repository](https://github.com/DSACMS/repo-scaffolder/)
